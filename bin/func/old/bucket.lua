...
if FUNC                    then print("FUNC ..."                     , "exists" ); end;
if FUNC.meta               then print("FUNC.meta ..."                , "exists" ); end;
if FUNC.meta.register_func then print("FUNC.meta.register_func ..." , "exists" ); end;
if FUNC.meta.register_cat  then print("FUNC.meta.register_cat ..."  , "exists" ); end;
...
if FUNC.meta and FUNC.meta.register_func then register_func = FUNC.meta.register_func; else eprint("Error: no function", "register_func" ); os.exit( ); end;
if FUNC.meta and FUNC.meta.register_cat  then register_cat  = FUNC.meta.register_cat;  else eprint("Error: no function", "register_cat"  ); os.exit( ); end;
